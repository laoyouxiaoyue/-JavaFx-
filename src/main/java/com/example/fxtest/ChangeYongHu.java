...
public class ChangeYongHu {
    ...
    public ChangeYongHu(Connection conn, Statement stat, ObservableList observableList) {
        this.conn=conn;
    ...
    {
        beforename=observableList.get(0).toString();
        YongHuMing.setText(observableList.get(0).toString());
        MiMa.setText(observableList.get(1).toString());
        Telephone.setText(observableList.get(3).toString());
        ChongFuMiMa.setText(observableList.get(1).toString());
        Birth.setValue(LocalDate.parse(observableList.get(2).toString()));
        Email.setText(observableList.get(4).toString());
        QX.setValue(observableList.get(5).toString());
        QX.getItems().add("1");
        QX.getItems().add("2");
        QX.getItems().add("3");
    ...
    void OnSubmit(ActionEvent event) throws SQLException {
        ...
        if (ok.next()&&!beforename.equals(yonghuming)) {
        ...
        String sql="update users set 用户名='"+YongHuMing.getText()+"',密码='"+MiMa.getText()+"',出生日期='"+Birth.getValue().toString()+"',手机号码='"+Telephone.getText()+"',电子邮箱='"+Email.getText()+"',权限="+QX.getValue()+" where 用户名='"+beforename+"'";
        stat.execute(sql);
